...
SOURCE_MODULES = [
    ...
    "app.providers.mock",
    "app.providers.mock.provider",
    "app.services",
    "app.services.cost_monitor",
    "app.services.deployment_store",
    "app.services.open_webui_manager",
    "app.services.orchestrator",
    "app.services.ws_manager",
    "app.routers",
    "app.routers.cost",
    "app.routers.deployments",
    "app.routers.open_webui",
